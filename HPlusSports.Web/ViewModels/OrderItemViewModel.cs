...
namespace HPlusSports.Web.ViewModels
{
    ...
    public class OrderListItemViewModel : Order, IOrderListItemViewModel
    {

        public OrderListItemViewModel(IEnumerable<Order> orders, Order o)
        {
            ...
            PreviousOrderDates = string.Join("\n",
                        orders
                            .FilterdSelect(o => o.CustomerId == CustomerId
    ...
    public interface IOrderListItemViewModel
    {
        int CustomerId {get;}
