...
namespace HPlusSports.Web.ViewModels
{
    public class OrderListItemViewModel{
        ...
        public OrderListItemViewModel(IEnumerable<Order> orders, Order adaptee)
        { 
            order = adaptee;
            PreviousOrderDates = string.Join("\n", 
                        orders
                            .FilterdSelect(o => o.CustomerId == order.CustomerId 
        ...
        public string CustomerName => order.Customer.FirstName + " " + order.Customer.LastName;
